    ...
    return (
        <section className="py-16 px-5 flex flex-col justify-center items-center">
            <div className="max-w-xl w-full flex flex-col gap-y-10 text-center p-16 bg-gray-400/20 backdrop-blur-lg rounded-lg">
                <h2 className="confirm_selection text-4xl max-sm:text-2xl uppercase font-bold reveal bg-gradient-to-r from-[#9945FF] via-[#8752F3] to-[#19FB9B] bg-clip-text text-transparent">
                    Elon's stable coin
                </h2>
